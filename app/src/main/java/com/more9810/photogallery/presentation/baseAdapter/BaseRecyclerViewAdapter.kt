//package com.example.mealz.ui.adapters.baseAdapter
//
...
//        when (holder) {
//            is ItemViewHolder -> {
//            holder.binding.setVariable(BR.itemCategory,currentItem)
//            }
//
...
//        val myDiffer = MyDiffer(item, newItem, ::isSame)
